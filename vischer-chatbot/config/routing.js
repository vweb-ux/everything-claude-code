...
const TOPIC_ROUTING = Object.freeze({
  de: [
    ...
    { serviceId: "data_ai", patterns: [/\bdatenschutz\b/i, /\bdsgvo\b/i, /\bdatenschutzgesetz\b/i, /\bdsg\b/i, /\bdatenverarbeitung\b/i, /\bdatenschutzverletzung\b/i, /\bdatensicherheit\b/i, /\bprivacy\b/i, /\bdatenschutzbeauftragter\b/i, /\bkünstliche intelligenz\b/i, /\bki-recht\b/i, /\bai-recht\b/i, /\bdata.*ai\b/i] },
    ...
    { serviceId: "insurance", patterns: [/\bversicherung\b/i, /\bversicherungsrecht\b/i, /\bversicherungsgesellschaft\b/i, /\bversicherungsvertrag\b/i, /\bhaftpflicht\b/i] },
    ...
    { serviceId: "sports_business", patterns: [/\bsportrecht\b/i, /\bsport business\b/i, /\bsports business\b/i, /\bsportvertrag\b/i, /\bsportveranstaltung\b/i, /\bsportler\b/i, /\btransferrecht\b/i] },
    { serviceId: "transport_aviation", patterns: [/\btransport\b/i, /\bluftfahrt\b/i, /\baviation\b/i, /\bfluggesellschaft\b/i, /\braumfahrt\b/i, /\bspace\b/i] },
    ...
    { serviceId: "regulatory_compliance", patterns: [/\bcompliance\b/i, /\bverwaltungsverfahren\b/i, /\bregulierungsbehörde\b/i, /\bverwaltungsgericht\b/i, /\bverwaltungsverfahrensrecht\b/i] },
    ...
    { serviceId: "ict_emerging_tech", patterns: [/\bit-recht\b/i, /\binformationsrecht\b/i, /\bkommunikationsrecht\b/i, /\btelekommunikation\b/i, /\btechnologierecht\b/i, /\bict\b/i, /\bemerging tech\b/i, /\bnew technology\b/i] },
  ...
  en: [
    ...
    { serviceId: "data_ai", patterns: [/\bdata (protection|privacy|security)\b/i, /\bgdpr\b/i, /\bdpo\b/i, /\bdata breach\b/i, /\bprivacy policy\b/i, /\bdata.*ai\b/i, /\bartificial intelligence\b/i, /\bai regulation\b/i, /\bai law\b/i] },
    ...
    { serviceId: "insurance", patterns: [/\binsurance\b/i, /\binsurance law\b/i, /\binsurance company\b/i, /\binsurance contract\b/i, /\bliability insurance\b/i, /\bindemnity\b/i] },
    ...
    { serviceId: "sports_business", patterns: [/\bsports? law\b/i, /\bsports? business\b/i, /\bsports? contract\b/i, /\bathletes?\b/i, /\btransfer rights?\b/i] },
    { serviceId: "transport_aviation", patterns: [/\btransport\b/i, /\baviation\b/i, /\bairline\b/i, /\bshipping\b/i, /\bspace law\b/i, /\baerospace\b/i] },
    ...
    { serviceId: "regulatory_compliance", patterns: [/\bcompliance\b/i, /\badministrative procedures?\b/i, /\bregulatory compliance\b/i, /\badministrative court\b/i] },
    ...
    { serviceId: "ict_emerging_tech", patterns: [/\bit law\b/i, /\btechnology law\b/i, /\bcyber\b/i, /\btelecommunication\b/i, /\bict\b/i, /\bemerging tech(nolog)?\b/i] },
  ...
  fr: [
    ...
    { serviceId: "data_ai", patterns: [/\bprotection des données\b/i, /\brgpd\b/i, /\bconfidentialité\b/i, /\bviolation de données\b/i, /\bintelligence artificielle\b/i, /\bdata.*ai\b/i] },
    ...
    { serviceId: "insurance", patterns: [/\bassurance\b/i, /\bdroit des assurances\b/i, /\bcompagnie d'assurance\b/i, /\bcontrat d'assurance\b/i] },
    ...
    { serviceId: "sports_business", patterns: [/\bdroit du sport\b/i, /\bsports business\b/i, /\bcontrat sportif\b/i, /\bathlètes?\b/i] },
    { serviceId: "transport_aviation", patterns: [/\btransport\b/i, /\baviation\b/i, /\bcompagnie aérienne\b/i, /\baérospatial\b/i] },
    ...
    { serviceId: "regulatory_compliance", patterns: [/\bcompliance\b/i, /\bprocédures administratives\b/i, /\bréglementation\b/i, /\btribunal administratif\b/i] },
    { serviceId: "public_sector", patterns: [/\bsecteur public\b/i, /\bréglementaire\b/i, /\bdroit administratif\b/i] },
    { serviceId: "ict_emerging_tech", patterns: [/\bdroit de l'information\b/i, /\bdroit informatique\b/i, /\bcyber\b/i, /\bict\b/i, /\btechnologies émergentes\b/i] },
  ...
  zh: [
    ...
    { serviceId: "data_ai", patterns: [/数据保护/, /个人信息保护/, /数据安全/, /隐私/, /数据泄露/, /人工智能/, /ai法律/, /数据与人工智能/] },
    ...
    { serviceId: "insurance", patterns: [/保险/, /保险法/, /保险公司/, /保险合同/, /保险索赔/] },
    ...
    { serviceId: "sports_business", patterns: [/体育/, /体育法/, /体育商业/, /运动员/, /体育合同/] },
    { serviceId: "transport_aviation", patterns: [/运输/, /航空/, /航空公司/, /航天/, /太空法/] },
    { serviceId: "pension_funds", patterns: [/养老/, /社会保险/, /退休/] },
    { serviceId: "health_care", patterns: [/医疗/, /保健/, /医院/, /医药法/] },
    { serviceId: "regulatory_compliance", patterns: [/合规/, /行政程序/, /监管合规/, /行政诉讼/] },
    { serviceId: "public_sector", patterns: [/公共部门/, /监管/, /行政法/] },
    { serviceId: "ict_emerging_tech", patterns: [/信息法/, /通讯法/, /网络安全/, /电信/, /ict/, /新兴技术/] },
